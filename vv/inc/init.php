...
if (isset($allheaders['User-Agent']) && stripos($allheaders['User-Agent'], 'vxiaotou-spider') > -1) {
	ShowMsg("不能互相采集万能小偷系统", "-1", 3000);
} 
...
<script type="text/javascript" src="../inc/common.inc.php?action=c5&file=vivi.js&key=5675&_t='.$randtime.'"></script>
